...
export const getAgreements = () => (dispatch, getState) => {
    axios
        .get('/api/agreements/', tokenConfig(getState))
        .then((res) => {
            dispatch({
                type: GET_AGREEMENTS,
                payload: res.data,
...
export const deleteAgreement = (id) => (dispatch, getState) => {
    axios
        .delete(`/api/agreements/${id}/`, tokenConfig(getState))
        .then(() => {
...
export const addAgreement = (agreement) => (dispatch, getState) => {
    axios
        .post('/api/agreements/', agreement, tokenConfig(getState))
        .then((res) => {
...
export const editAgreement = (id, agreement) => (dispatch, getState) => {
    axios
        .put(`/api/agreements/${id}/`, agreement, tokenConfig(getState))
        .then((res) => {
