...
import {addReposirory} from '../../actions/repositories';

class RepositoriesForm extends Component {
    static propTypes = {
        addReposirory: PropTypes.func.isRequired
    };
    state = {
        agreement_id: '',
        inventory_number: '',
    ...
    onSubmit = e => {
        ...
        this.props.addReposirory(request);
        this.setState({
            agreement_id: '',
            inventory_number: '',
            name: '',
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h2 className="modal-title" id="exampleModalLabel">Добавить запись</h2>
...
export default connect(null, {addReposirory})(RepositoriesForm);