...
router.register('list_studetns_with_more_4',            ListStudentsWithMore4,              basename="studetns_with_more_4")
router.register('list_studetns_with_more_3',            ListStudentsWithMore3,              basename="studetns_with_more_3")
router.register('list_studetns_with_more_2',            ListStudentsWithMore2,              basename="studetns_with_more_2")
...
router.register('list_studetns_with_less_3',            ListStudentsWithLess3,              basename="studetns_with_less_3")
router.register('list_studetns_with_less_2',            ListStudentsWithLess2,              basename="studetns_with_less_2")
